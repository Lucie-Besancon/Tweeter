...
abstract class AbstractView {
  ...
  protected $data        = null; /* les donn̩es n̩cessaires */
  ...
  *
  * Permet de stocker un nom pour l'application (affich̩ sur le navigateur)
  ...
  * de style. Le contenu du document est le r̩sultat des m̩thodes
  * renderBody des sous-classes.
  *
  * Elle utilise la syntaxe HEREDOC pour d̩finir un patron et
  * ̩crire la chaine de caract̬re de la page enti̬re. Voir la
  * documentation ici:
  *
