...
class RouterTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testSubclass(){
        $this->assertTrue(is_subclass_of('\mf\router\Router', '\mf\router\AbstractRouter'),
           "FEEDBACK : La class Router doit concr̩tiser AbstractRouter");
    }
    ...
    public function testAddRoute(){
        ...
        $this->assertTrue(array_key_exists($url, $routes),
          "FEEDBACK : le tableau self::\$routes doit avoir les URL comme cl̩");
        ...
        $this->assertTrue(array_key_exists($name, $aliases),
          "FEEDBACK : le tableau self::\$alises doit avoir les noms des routes comme cl̩");
    ...
    public function testSetDefaultRoute(){
        ...
        $this->assertTrue(array_key_exists('default', $aliases),
                          "FEEDBACK : la route par d̩faut doit ̻tre enregistr̩e sous la cl̩ 'default' dans tableau self::\$alises");
    ...
    public function testRun(){
        ...
        $this->expectOutputString($expected, "FEEDBACK : la m̩thode run doit ex̩cuter le m̩thode du contr̫leur de la route demand̩e dans le PATH_INFO.\nE.g. : si url = \"http://localhost/Tweeter/main.php/home/\",  run doit ex̩cuter view_home sur une instance de TweeterController." );
     ...
     public function testUrlFor(){
        ...
        $this->assertEquals($r->urlFor($name), $expected,
                           "FEEDBACK : La m̩thode urlFor doit retourner l'url compl̬te de la route nomm̩e.\nE.g. : urlFor('home') retourne \"/Tweeter/main.php/home/\"");
